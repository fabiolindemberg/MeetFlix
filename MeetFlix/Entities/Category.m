...
+ (NSArray<Category*>*) getCategories {
    ...
    theWitcher.coverURL = @"https://i.pinimg.com/originals/5f/e2/16/5fe21664f1932fe8593166204ed5d79a.png";
    ...
    brooklyn99.coverURL = @"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQcRdR65ZJc4cdGDXvJQmMqsrTc1wuXzThsYTxxNxld7X9_aT-y";
    ...
    Movie * theHangover = [Movie new];
    theHangover.title = @"Se Beber não Case";
    theHangover.coverURL = @"https://upload.wikimedia.org/wikipedia/pt/b/b9/Hangoverposter09.jpg";
    theHangover.text = @"Dois dias antes de seu casamento, Doug e três amigos vão de carro até Las Vegas para uma louca e memorável despedida de solteiro. Quando os três padrinhos acordam na manhã seguinte, eles não conseguem se lembrar de nada e notam que Doug desapareceu.";
    theHangover.age = 12;
    theHangover.year = @"2009";
    theHangover.temp = @"1h 48m";
    theHangover.casting = @"Starring: Bredley Cooper, Ed Helms, Justin Bartha";
    theHangover.creators = @"Creators: Todd Phillips";
    theHangover.time = @"Time remaining: 2m";
    theHangover.relevant = @"56% relevant";
    theHangover.progress = 0.49;
    
    Movie * gameOfThrones = [Movie new];
    gameOfThrones.title = @"Game of Thrones";
    gameOfThrones.coverURL = @"https://br.web.img3.acsta.net/pictures/19/03/21/16/15/4239577.jpg";
    gameOfThrones.text = @"Famílias nobres e poderosas disputam um jogo mortal pelo controle dos Sete Reinos de Westeros para assumir o Trono de Ferro.";
    gameOfThrones.age = 12;
    gameOfThrones.year = @"2011";
    gameOfThrones.temp = @"1h 48m";
    gameOfThrones.casting = @"Starring: Emilia Clarke, Kit Harington, Sophie Turner";
    gameOfThrones.creators = @"Creators: George R. R. Martin, David Benioff, D. B. Weiss, Vanessa Taylor, Bryan Cogman, Jane Espenson, Dave Hill";
    gameOfThrones.time = @"Time remaining: 2m";
    gameOfThrones.relevant = @"56% relevant";
    gameOfThrones.progress = 0.49;
    
    Movie * theLastAirBender = [Movie new];
    theLastAirBender.title = @"Avatar: A lenda de Aang";
    theLastAirBender.coverURL = @"https://encrypted-tbn1.gstatic.com/images?q=tbn:ANd9GcSsQ-GjY4-orc7i_pxF4nG2P34prF88N7R9KaxJsaumuDO3zFIj";
    theLastAirBender.text = @"Os irmãos Katara e Sokka acordam o jovem Aang de uma longa hibernação e descobrem que ele é um Avatar, com poderes que podem derrotar a Nação do Fogo.";
    theLastAirBender.age = 12;
    theLastAirBender.year = @"2011";
    theLastAirBender.temp = @"1h 48m";
    theLastAirBender.casting = @"Starring:  Zach Tyler Eisen, Mae Whitman, Jack DeSena";
    theLastAirBender.creators = @"Creators:  Michael Dante DiMartino, Bryan Konietzko, Aaron Ehasz, John O'Bryan";
    theLastAirBender.time = @"Time remaining: 2m";
    theLastAirBender.relevant = @"56% relevant";
    theLastAirBender.progress = 0.49;
    

    [animationMovies addObject: theLastAirBender];
    ...
    [serieMovies addObject: gameOfThrones];
    ...
    [serieMovies addObject: theLastAirBender];

    [comedyMovies addObject:justGoWithIt];
    [comedyMovies addObject:theHangover];
